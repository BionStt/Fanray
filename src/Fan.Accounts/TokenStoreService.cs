...
namespace Fan.Accounts
{
    public class TokenStoreService : ITokenStoreService
    {
        ...
        private readonly DbSet<UserTokenOrig> _tokens;
        ...
        public Task<UserTokenOrig> FindTokenAsync(string refreshToken)
        {
